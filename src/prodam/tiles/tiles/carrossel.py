...
class ICarrosselTile(IListTile):
...
class CarrosselTile(ListTile):

    """A carousel based on the Galleria JS image gallery framework."""

    implements(ICarrosselTile)

    index = ViewPageTemplateFile('templates/carrossel.pt')
    is_configurable = True
    is_editable = True
    short_name = _(u'Carrossel Prodam', default=u'Carrossel Prodam')
